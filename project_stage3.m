...
% The program now has a written and image message which are displayed if no matching 
% atomic element is found.

%%

classdef project_stage3 < matlab.apps.AppBase
