%% PROJECT STAGE 7 (Final Stage)

% Added a header image to the prgram. Also added the atribute for the
% images used in the project.

% Added background color to the whole UIFigure and Panel.

%%

classdef project_final < matlab.apps.AppBase
    
    % Properties that correspond to app components
    properties (Access = public)
        UIFigure matlab.ui.Figure
        AlltheimagesusedinthisprojectaretakenfromfreepikcomLabel matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        % Removing elements from page based on the simple or grouped menu.
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Color = [0.8706 0.949 0.9412];
            ...
            app.Panel.BackgroundColor = [0.8706 0.949 0.9412];
            ...
            app.Image2.Position = [1 402 619 105];
            app.Image2.ImageSource = fullfile(pathToMLAPP, 'header.jpg');
            ...
            % Create AlltheimagesusedinthisprojectaretakenfromfreepikcomLabel
            app.AlltheimagesusedinthisprojectaretakenfromfreepikcomLabel = uilabel(app.UIFigure);
            app.AlltheimagesusedinthisprojectaretakenfromfreepikcomLabel.HorizontalAlignment = 'center';
            app.AlltheimagesusedinthisprojectaretakenfromfreepikcomLabel.Position = [4 479 616 26];
            app.AlltheimagesusedinthisprojectaretakenfromfreepikcomLabel.Text = 'All the images used in this project are taken from freepik.com';
