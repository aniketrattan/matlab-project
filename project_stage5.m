...
% Added a button to switch to the second part of the program. 

% Added the code and functionality to display the atomic elements type.

% The value entered by the user in the input fields now resets when a
% different option is selected from the dropdown menu

%%

classdef project_stage5 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ThisprogramletsyouLabel.Position = [1 400 619 106];
            app.ThisprogramletsyouLabel.Text = ['This program lets you go ' ...
                'through the atomic elements of the periodic table. '];
            ...
            app.GroupedDropdown.Items = {'Actinoids', 'Alkali Metals',...
                'Alkaline Earth Metals', 'Lanthanoids', 'Metalloids',...
                'Noble Gases', 'Post-Trasition Metals', 'Reactive Nonmetals',...
                'Transition Metals', 'Unknown'};
